...
const handleSubmit = (evt)=>{
    evt.preventDefault();
    if (input.value === "" || textarea.value === "") return alert("please fill all the fields!");
...
const check = ()=>{
    ...
    else if (localStorage.getItem("feedback-form-state") === null) return;
    else if (parsedLoad.email !== null || parsedLoad.textarea !== null) {
        input.value = parsedLoad.email;
        textarea.value = parsedLoad.textarea;
    }
};
window.addEventListener("load", check); //reload page

},{"i/lib/inflections":"e090p","lodash":"3qBDj"}],"e090p":[function(require,module,exports) {
...
Inflections.prototype.plural = function(rule, replacement) {
    if (typeof rule == "string") this.uncountables = util.array.del(this.uncountables, rule);
...
},{"./util":"ekaoD","./defaults":"l3JlG"}],"ekaoD":[function(require,module,exports) {
...
var u = module.exports = {
    ...
    string: {
        ...
        gsub: function(str, pattern, replacement) {
            ...
            result = "";
            self = str;
            while(self.length > 0)if (match = self.match(pattern)) {
                ...
                if (typeof replacement === "function") {
                    ...
                    for(i = 1; i <= 9; i++)if (matchCmpr[i]) replacementStr = u.string.gsub(replacementStr, new RegExp("\\$" + i), matchCmpr[i]);
        ...
        capitalize: function(str, spaces) {
            ...
            if (!spaces) self = u.string.gsub(self, /\s([a-z])/, function($) {
                return " " + $[1].toUpperCase();
            });
            return self[0].toUpperCase() + self.substr(1);
        },
...
},{}],"l3JlG":[function(require,module,exports) {
// Default inflections
